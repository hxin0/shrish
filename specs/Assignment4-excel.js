...
describe('excel', function () {
    protractor_1.browser.ignoreSynchronazation = true;
    xit('excel;', function () {
        ...
        wb.xlsx.readFile("./test.xlsx").then(function () {
            var sheet = wb.getWorksheet("Sheets");
            var rowObj = sheet.getRow(3);
        });
    });
});
describe('BankManager Testing with Excel', function () {
    // Launch
    it('Launch and enter value in BankManager', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, protractor_1.browser.get(data.customerData1.testUrl)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('enter the first name value', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, protractor_1.$('input[ng-model="fName"]').sendKeys(data.customerData1.firstname)
    ...
    it('enter the last name value', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, protractor_1.$('input[ng-model="lName"]').sendKeys(data.customerData1.lastname)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('enter the postal code value', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, protractor_1.element(protractor_1.by.css('input[ng-model="postCd"]')).sendKeys(data.customerData1.postalcode)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=Assignment4-excel.js.map