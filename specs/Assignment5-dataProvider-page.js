...
var loc = new bankmanager_1.AddCustomer();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            describe('BankManager Testing', function () {
                ...
                it('Click on Bank Manager Login button', function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, loc.clickonBankManagerLoginButton()];
                            case 1:
                                _a.sent();
                                return [3 /*break*/, 3];
                            case 2:
                ...
                it('Click on Add customer button', function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, loc.clickonAddCustomerButton()];
                            case 1:
                                _a.sent();
                                return [3 /*break*/, 3];
                            case 2:
                ...
                it('enter value', function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, loc.enterFirstName(data.firstname)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, loc.enterLastName(data.lastname)];
                            case 2:
                                _a.sent();
                                return [4 /*yield*/, loc.enterPostalcode(data.postalcode)];
                            case 3:
                                _a.sent();
                                return [2 /*return*/];
                        }
                ...
                it('enter submit button', function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, loc.clickSubmit()];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
...
//# sourceMappingURL=Assignment5-dataProvider-page.js.map