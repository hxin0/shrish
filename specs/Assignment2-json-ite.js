...
var bankmanagerloginbtn = 'button[ng-click="manager()"]';
var addcustomerbtn = 'button[ng-click="addCust()"]';
            ...
            describe('BankManager Testing', function () {
                ...
                it('Click on Bank Manager Login button', function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                elcss = protractor_1.$(bankmanagerloginbtn);
                                _a.label = 1;
                            case 1:
                                _a.trys.push([1, 5, , 6]);
                ...
                it('Click on Add customer button', function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, protractor_1.$(addcustomerbtn).click()];
                            case 1:
                                _a.sent();
                                return [3 /*break*/, 3];
                            case 2:
...
//# sourceMappingURL=Assignment2-json-ite.js.map