...
describe('BankManager Testing', function () {
    ...
    it('Launch and enter value in BankManager', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, protractor_1.browser.get("http://www.way2automation.com/angularjs-protractor/banking/#/login")];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    it('enter the first name value', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, protractor_1.$('input[ng-model="fName"]').sendKeys("Adam")
    ...
    it('enter the last name value', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, protractor_1.$('input[ng-model="lName"]').sendKeys("Gyse")];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('enter the postal code value', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, protractor_1.element(protractor_1.by.css('input[ng-model="postCd"]')).sendKeys("72745")];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
